...
I split the FeaturedProducts own Server Component and wrap it in its own Suspense Boundary to allow next stream the response and update. This allows us to instantly load the hero content. Nothing is blocked by the fetches on the page.
